...
#define LEDA_ROOT_INCL_ID 661229
...
inline unsigned long long ID_Number(const void* x)// { return *(unsigned long long*)&x; }
{
...
inline unsigned long long ID_Number(unsigned int  x) { return (unsigned long long)x; }
inline unsigned long long ID_Number(unsigned long x) { return (unsigned long long)x; }
#else
