...
#define LEDA_ROOT_INCL_ID 661078
...
/*{\Mcreate creates an instance $Q$ of type |\Mname| for the nodes of graph $G$
    with $dom(Q)=\emptyset$.}*/
...
/*{\Mop          returns positive integer if |\Mvar| is the empty node
		 priority queue, 0 otherwise.}*/
