...
#define LEDA_ROOT_INCL_ID 661072
...
inline int ORTHO_EMBEDDING(const graph& G, const edge_array<int>& maxbends,
                                           node_array<int>& xpos,
                                           node_array<int>& ypos,
                                           edge_array<list<int> >& xbends,
                                           edge_array<list<int> >& ybends)
{ node_array<bool> crossing(G, false);
  return ORTHO_EMBEDDING(G, crossing, maxbends, xpos, ypos, xbends, ybends);
}
