...
#define LEDA_ROOT_INCL_ID 661100
...
/*{\Mfuncl
a variant of TOPSORT that rearranges nodes and edges of $G$ 
in topological order (edges are sorted by the topological number
