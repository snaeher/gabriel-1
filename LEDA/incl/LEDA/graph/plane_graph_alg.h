...
#define LEDA_ROOT_INCL_ID 661081
...
for it. $G$ must not contain self-loops. If the second argument $embed$ has 
...
If $G$ is not planar a Kuratowski-Subgraph is computed and returned in $el$.  
\bigskip
}*/
...
/*{\Mfuncl
KURATOWSKI computes a Kuratowski subdivision $K$ of $G$ as follows. $V$ is the 
