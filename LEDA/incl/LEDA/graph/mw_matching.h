...
All functions assume the underlying graph (type |graph|) to be connected, simple, and loopfree.
They work on the underlying undirected graph of the directed graph parameter.
...
/*{\Mfunc computes a maximum-weight matching |M| of the underlying undirected graph of graph |G| with weight
