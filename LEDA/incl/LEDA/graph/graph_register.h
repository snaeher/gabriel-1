...
#ifndef LEDA_GRAPH_REGISTER_H
#define LEDA_GRAPH_REGISTER_H

#if !defined(LEDA_ROOT_INCL_ID)
#define LEDA_ROOT_INCL_ID 661079
...
leda_mutex reg_mutex1;
leda_mutex reg_mutex2;
#else
