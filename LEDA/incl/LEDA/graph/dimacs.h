...
#define LEDA_ROOT_INCL_ID 661097
...
/*{\Mopl   as above for double capacity values. }*/
...
extern __exportF void Read_Dimacs_MCF(istream& in, graph& G, 
                                                   node_array<double>& supply,
                                                   edge_array<double>& lcap,
                                                   edge_array<double>& ucap,
                                                   edge_array<double>& cost);

/*{\Mopl   as above for double values. }*/
