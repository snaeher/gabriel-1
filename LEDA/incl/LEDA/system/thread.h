...
#define LEDA_ROOT_INCL_ID 661326
#include <LEDA/internal/PREAMBLE.h>
#endif

LEDA_BEGIN_NAMESPACE

extern __exportF unsigned long get_thread_id();

extern __exportF unsigned long tls_alloc();
extern __exportF void  tls_free(unsigned long i);
extern __exportF void* tls_get_value(unsigned long i);
extern __exportF void  tls_set_value(unsigned long i, void* x);
...
/*
#elif (defined(__linux__) || defined(linux) || defined(__APPLE__)) && defined(__GNUC__)
*/
