...
#if defined(sparc) || (defined(i386) && !defined(sun) && !defined(__APPLE__) && !defined(__geode__)) || defined(__amd64) || (defined(mips) && !defined(__MIPSEL__)) || defined(alpha) || defined(hppa) || (defined(powerpc) && defined(__GNUC__)) 
