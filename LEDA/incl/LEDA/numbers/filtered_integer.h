...
#define LEDA_ROOT_INCL_ID 661270
...
{ PTR = new filtered_integer_rep(i,2*std::abs(i),0.5); }

// fabs ?

inline filtered_integer::filtered_integer(double d)  
{ PTR = new filtered_integer_rep(d,2*std::fabs(d),0.5); }
...
COMPARE_DECL_PREFIX
inline int compare(const filtered_integer& x, const filtered_integer& y) 
