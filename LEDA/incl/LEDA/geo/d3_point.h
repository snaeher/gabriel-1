...
#define LEDA_ROOT_INCL_ID 661216
...
double  distance() const { return distance(d3_point(0,0,0)); }
/*{\Mop     returns the Euclidean distance between |\Mvar| and the origin.}*/
...
d3_point rotate_around_axis(int a, double phi) const;
/*{\Mop     returns |\Mvar| rotated by angle $phi$ around the $x$-axis if $a=1$,
            aournd the $y$-axis if $a=1$, or around the $z$-axis if $a = 2$. }*/

d3_point rotate_around_vector(const vector& u, double phi) const;
/*{\Mop     returns |\Mvar| rotated by angle $phi$ around the axis defined
            by vector $u$. }*/


d3_point cartesian_to_polar() const;
/*{\Mop     returns |\Mvar| converted to polar coordinates. }*/

d3_point polar_to_cartesian() const;
/*{\Mop     returns |\Mvar| converted to cartesian coordinates. }*/
