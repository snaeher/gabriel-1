...
#define LEDA_ROOT_INCL_ID 661222
...
real_line to_line() const { return real_line(point1(), point3()); }
...
__exportF int intersection(const rat_circle& c, const rat_line& l, two_tuple<real_point,real_point>& inter);
__exportF list<real_point> intersection(const rat_circle& c, const rat_line& l);
