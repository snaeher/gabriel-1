...
#define LEDA_ROOT_INCL_ID 661215
...
extern __exportF list<rat_point> CONVEX_HULL_S0(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_S1(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_S2(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_S3(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_S3F(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_S4F(const list<rat_point>& L);



extern __exportF list<rat_point> CONVEX_HULL_IC(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_ICF(const list<rat_point>& L);
extern __exportF list<rat_point> CONVEX_HULL_ICF2(const list<rat_point>& L);
...
extern __exportF list<rat_point> CONVEX_HULL_RIC1(const list<rat_point>& L);
...
extern __exportF edge LOCATE_IN_TRIANGULATION(const GRAPH<rat_point,int>& G, 
                                              rat_point p, edge start = 0);

extern __exportF edge LOCATE_IN_TRIANGULATION(const GRAPH<rat_point,rat_segment>& G, 
                                         rat_point p, edge start = 0);


extern __exportF edge LOCATE_IN_TRIANGULATION(const graph& G, 
                                              const node_array<rat_point>& pos, 
                                              rat_point p, edge start = 0);
...
extern __exportF bool Is_Voronoi_Diagram(const GRAPH<rat_circle,rat_point>& G, 
                        delaunay_voronoi_kind kind);
...
extern __exportF void CURVE_SWEEP_SEGMENTS(const list<rat_segment>& S, 
                                           GRAPH<rat_point,rat_segment>& G, 
                                           bool embed);
                 // implemented in _curve_sweep.cpp
...
extern __exportF void Minimal_Area_Bounding_Box(const list<rat_point>& L, rat_point& p1, 
                                                             rat_point& p2,
                                                             rat_point& p3, 
                                                             rat_point& p4);

/*{\Mfuncl
computes four points $p1,p2,p3,p4$ from $L$ such that these points represent
the corners of the smallest rectangle containing all of the points in $L$. \precond  $L$ is
not empty. }*/
