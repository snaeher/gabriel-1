...
#define LEDA_ROOT_INCL_ID 661162
...
static int cmp_x(const real_point& a, const real_point& b) { return compare(a.xcoord(),b.xcoord()); }
static int cmp_y(const real_point& a, const real_point& b) { return compare(a.ycoord(),b.ycoord()); }
...
COMPARE_DECL_PREFIX
inline int compare(const real_point& a, const real_point& b)
{
