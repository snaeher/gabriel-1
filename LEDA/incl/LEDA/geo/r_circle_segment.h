...
#define LEDA_ROOT_INCL_ID 661145
...
/*{\Moperations}*/
	...
	{ 
		if (target() != source()) return r_circle_segment(target(), source(), circle().reverse());
		else return r_circle_segment(circle().reverse());}
