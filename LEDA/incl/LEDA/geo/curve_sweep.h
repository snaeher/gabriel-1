...
#define LEDA_ROOT_INCL_ID 661188
...
private:
	...
	void embedding_corresponding_edges_for(node n, edge_array<edge>& corresp_edge);
	void simple_graph_corresponding_edges_for(node n, edge_array<edge>& corresp_out_edge);
