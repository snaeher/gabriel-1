...
#define LEDA_ROOT_INCL_ID 661299
...
GeoEditScene<typename TRAITS::CONTAINER>* geowin_init_default_type(TRAITS tr)
{
  ...
  sc->post_window_default_input_handler = NULL;
...
{ 
  ...
  GeoBaseScene< T >* bsc= make_base_prototype GEOWIN_FU_TEMPL (t, str+string("Base"));
