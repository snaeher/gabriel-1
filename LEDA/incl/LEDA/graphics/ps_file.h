...
#define LEDA_ROOT_INCL_ID 661296
...
public:
  ...
  // Drawing points
  void draw_point(double, double, color c=FG_COLOR);
  void draw_point(point, color c=FG_COLOR);
  void draw_pixel(double, double, color c=FG_COLOR);
  void draw_pixel(point, color c=FG_COLOR);

  // Drawing line segments
  void draw_segment(double, double, double, double, color c=FG_COLOR);
  void draw_segment(point, point, color c=FG_COLOR);
  void draw_segment(segment, color c=FG_COLOR);

  void draw_ray(double, double, double, double, color c=FG_COLOR);
  void draw_ray(const point&, const point&, color c=FG_COLOR);
  void draw_ray(const segment&, color c=FG_COLOR);
  void draw_ray(const ray&, color c=FG_COLOR);

  // Drawing lines
  void draw_line(double, double, double, double, color c=FG_COLOR);
  void draw_line(point, point, color c=FG_COLOR);
  void draw_line(segment, color c=FG_COLOR);
  void draw_line(line, color c=FG_COLOR);
  void draw_hline(double, color c=FG_COLOR);
  void draw_vline(double, color c=FG_COLOR);
  void draw_arc(double, double, double, double, double, color c=FG_COLOR);
  void draw_arc(point, point, double, color c=FG_COLOR);
  void draw_arc(segment, double, color c=FG_COLOR);

  // Drawing arrows
  void draw_arrow_head(point, double, color c=FG_COLOR);
  void draw_arrow(double, double, double, double, color c=FG_COLOR);
  void draw_arrow(point, point, color c=FG_COLOR);
  void draw_arrow(segment, color c=FG_COLOR);
  void draw_arc_arrow(double, double, double, double, double, color c=FG_COLOR);
  void draw_arc_arrow(point, point, double, color c=FG_COLOR);
  void draw_arc_arrow(segment, double, color c=FG_COLOR);

  // Drawing circles
  void draw_circle(double, double, double, color c=FG_COLOR);
  void draw_circle(point, double, color c=FG_COLOR);
  void draw_circle(circle, color c=FG_COLOR);
  void draw_ellipse(double, double, double, double, color c=FG_COLOR);
  void draw_ellipse(point, double, double, color c=FG_COLOR);

  // Drawing discs
  void draw_disc(double, double, double, color c=FG_COLOR);
  void draw_disc(point, double, color c=FG_COLOR);
  void draw_disc(circle, color c=FG_COLOR);
  void draw_filled_ellipse(double, double, double, double, color c=FG_COLOR);
  void draw_filled_ellipse(point, double, double, color c=FG_COLOR);
 
  // Drawing polygons
  void draw_polygon(const list<point>&, color c=FG_COLOR);
  void draw_polygon(polygon, color c=FG_COLOR);
  void draw_filled_polygon(const list<point>&, color c=FG_COLOR);
  void draw_filled_polygon(polygon, color c=FG_COLOR);
  //new
  void draw_filled_polygon(gen_polygon, color c=FG_COLOR);
  
  void draw_rectangle(double, double, double, double, color c=FG_COLOR);
  void draw_rectangle(point, point, color c=FG_COLOR);
  void draw_rectangle(rectangle, color c=FG_COLOR); 
  void draw_box(double, double, double, double, color c=FG_COLOR);
  void draw_box(point, point, color c=FG_COLOR);
  void draw_box(rectangle, color c=FG_COLOR);
  void draw_triangle(point, point, point, color c=FG_COLOR);
  void draw_filled_triangle(point, point, point, color c=FG_COLOR);
  // new polygons from graphwin ...
  void draw_roundrect(double x0, double y0, double x1, double y1, double rnd, color c=FG_COLOR);
  void draw_filled_roundrect(double x0, double y0, double x1, double y1, double rnd, color c=FG_COLOR);

  // Drawing functions
  void plot_xy(double, double, win_draw_func, color c=FG_COLOR);
  void plot_yx(double, double, win_draw_func, color c=FG_COLOR);

  // Drawing text
  void draw_text(double, double, string, color c=FG_COLOR);
  void draw_text(point, string, color c=FG_COLOR);
  void draw_ctext(double, double, string, color c=FG_COLOR);
  void draw_ctext(point, string, color c=FG_COLOR);

  // Drawing nodes
  void draw_node(double, double, color c=FG_COLOR);
  void draw_node(point, color c=FG_COLOR);
  void draw_filled_node(double, double, color c=FG_COLOR);
  void draw_filled_node(point, color c=FG_COLOR);
  void draw_text_node(double, double, string, color c=FG_COLOR);
  void draw_text_node(point, string, color c=FG_COLOR);
  void draw_int_node(double, double, int, color c=FG_COLOR);
  void draw_int_node(point, int, color c=FG_COLOR);

  // Drawing edges
  void draw_edge(double, double, double, double, color c=FG_COLOR);
  void draw_edge(point, point, color c=FG_COLOR);
  void draw_edge(segment, color c=FG_COLOR);
  void draw_edge_arrow(double, double, double, double, color c=FG_COLOR);
  void draw_edge_arrow(point, point, color c=FG_COLOR);
  void draw_edge_arrow(segment, color c=FG_COLOR);
  void draw_arc_edge(double, double, double, double, double, color c=FG_COLOR);
  void draw_arc_edge(point, point, double, color c=FG_COLOR);
  void draw_arc_edge(segment, double, color c=FG_COLOR);
  void draw_arc_edge_arrow(double, double, double, double, double, color c=FG_COLOR);
  void draw_arc_edge_arrow(point, point, double, color c=FG_COLOR);
  void draw_arc_edge_arrow(segment, double, color c=FG_COLOR);
  // new from graphwin
  point draw_arrow_head_poly(const point& q, double a, color c=FG_COLOR);
  void draw_polygon_edge(const list<point>& P, int arrow, color c=FG_COLOR);
  void draw_bezier_edge(const list<point>& P, int arrow, color c=FG_COLOR);
  void draw_spline_edge(const list<point>& P, int arrow, color c=FG_COLOR);
  void draw_circle_edge(point p, point q, point r, int arrow, color c=FG_COLOR);
