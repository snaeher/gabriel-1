...
#define LEDA_ROOT_INCL_ID 661050
...
int   max_size()  const { return int(stop - first); }
/*{\Mop    returns the maximal size of |\Mvar| (given in constructor).}*/
