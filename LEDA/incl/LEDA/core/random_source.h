...
#define LEDA_ROOT_INCL_ID 661061
...
/*{\Mop         returns a random unsigned long integer ($32$ 
                bits on 32-bit systems or on LLP64 systems
				and $64$ bits on other 64-bit systems). }*/
