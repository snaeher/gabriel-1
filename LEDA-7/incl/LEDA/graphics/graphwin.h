...
#define LEDA_ROOT_INCL_ID 700325
...
//  agd client
    ...
    node start_node; // used in gw_new_edge
...
//------------------------------------------------------------------------------
    ...
    void (*undo_graph_handler)(GraphWin& gw);
...
void draw_obj_label(node,edge,string,color label_clr,double,double);
...
double set_node_radius(double r,bool b=true) { 
   set_node_radius1(r,b);
   return set_node_radius2(r,b); 
}
...
void enable_frame_actions(bool b) { frame_actions_enabled = b; }
...
void set_undo_graph_handler(void (*f)(GraphWin&)=NULL);
/*{\Mopl	$f$ is called after each undo operation.}*/
...
friend __exportF void gw_test_connectivity(GraphWin& gw); 
friend __exportF void gw_test_biconnectivity(GraphWin& gw); 
friend __exportF void gw_test_bipartiteness(GraphWin& gw); 
friend __exportF void gw_test_directedness(GraphWin& gw); 
friend __exportF void gw_test_simplicity(GraphWin& gw);
