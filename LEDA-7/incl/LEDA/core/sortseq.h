...
#define LEDA_ROOT_INCL_ID 700055
...
//typedef ab_tree::item seq_item;
typedef skiplist::item seq_item;


/*{\Manpage {sortseq} {K,I} {Sorted Sequences} {S}}*/

//template<class K, class I, class seq_impl = ab_tree>
