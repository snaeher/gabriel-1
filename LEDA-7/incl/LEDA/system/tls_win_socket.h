...
class tls_socket_impl
{
   ...
   int received;  // bytes in incoming buffer (ciphertext)
   int used;      // bytes used from incoming buffer to decrypt current packet
   int available; // bytes available for decrypted bytes
