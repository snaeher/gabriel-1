...
#define LEDA_ROOT_INCL_ID 700119
...
/*{\Moperations}*/
	...
	int write_to_buffer(char*& buf, const gen_polygon& P);

	bool read_from_buffer(int len, char* buf, gen_polygon& P);
